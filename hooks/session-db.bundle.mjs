import{createRequire as Q}from"node:module";import{existsSync as Z,unlinkSync as k,renameSync as J}from"node:fs";import{tmpdir as tt}from"node:os";import{join as et}from"node:path";var N=class{#t;constructor(t){this.#t=t}pragma(t){let n=this.#t.prepare(`PRAGMA ${t}`).all();if(!n||n.length===0)return;if(n.length>1)return n;let r=Object.values(n[0]);return r.length===1?r[0]:n[0]}exec(t){let e="",n=null;for(let o=0;o<t.length;o++){let a=t[o];if(n)e+=a,a===n&&(n=null);else if(a==="'"||a==='"')e+=a,n=a;else if(a===";"){let c=e.trim();c&&this.#t.prepare(c).run(),e=""}else e+=a}let r=e.trim();return r&&this.#t.prepare(r).run(),this}prepare(t){let e=this.#t.prepare(t);return{run:(...n)=>e.run(...n),get:(...n)=>{let r=e.get(...n);return r===null?void 0:r},all:(...n)=>e.all(...n),iterate:(...n)=>e.iterate(...n)}}transaction(t){return this.#t.transaction(t)}close(){this.#t.close()}},w=class{#t;constructor(t){this.#t=t}pragma(t){let n=this.#t.prepare(`PRAGMA ${t}`).all();if(!n||n.length===0)return;if(n.length>1)return n;let r=Object.values(n[0]);return r.length===1?r[0]:n[0]}exec(t){return this.#t.exec(t),this}prepare(t){let e=this.#t.prepare(t);return{run:(...n)=>e.run(...n),get:(...n)=>e.get(...n),all:(...n)=>e.all(...n),iterate:(...n)=>typeof e.iterate=="function"?e.iterate(...n):e.all(...n)[Symbol.iterator]()}}transaction(t){return(...e)=>{this.#t.exec("BEGIN");try{let n=t(...e);return this.#t.exec("COMMIT"),n}catch(n){throw this.#t.exec("ROLLBACK"),n}}}close(){this.#t.close()}},p=null;function nt(s){let t=null;try{return t=new s(":memory:"),t.exec("CREATE VIRTUAL TABLE __fts5_probe USING fts5(x)"),!0}catch{return!1}finally{try{t?.close()}catch{}}}function st(s,t){let e=t!==void 0?t:globalThis.Bun;if(typeof e<"u"&&e!==null)return!0;let n=s??process.versions,[r,o]=(n.node??"0.0.0").split("."),a=Number(r),c=Number(o);return!Number.isFinite(a)||!Number.isFinite(c)?!1:a>22||a===22&&c>=5}function rt(){if(!p){let s=Q(import.meta.url);if(globalThis.Bun){let t=s(["bun","sqlite"].join(":")).Database;p=function(n,r){let o=new t(n,{readonly:r?.readonly,create:!0}),a=new N(o);return r?.timeout&&a.pragma(`busy_timeout = ${r.timeout}`),a}}else if(st()){let t=null;try{({DatabaseSync:t}=s(["node","sqlite"].join(":")))}catch{t=null}t&&nt(t)?p=function(n,r){let o=new t(n,{readOnly:r?.readonly??!1});return new w(o)}:p=s("better-sqlite3")}else p=s("better-sqlite3")}return p}function it(s){s.pragma("journal_mode = WAL"),s.pragma("synchronous = NORMAL");try{s.pragma("mmap_size = 268435456")}catch{}}function U(s){if(!Z(s))for(let t of["-wal","-shm"])try{k(s+t)}catch{}}function ot(s){for(let t of["","-wal","-shm"])try{k(s+t)}catch{}}function b(s){try{s.pragma("wal_checkpoint(TRUNCATE)")}catch{}try{s.close()}catch{}}function B(s="context-mode"){return et(tt(),`${s}-${process.pid}.db`)}function at(s){if(!(s<=0))try{Atomics.wait(new Int32Array(new SharedArrayBuffer(4)),0,0,s)}catch{let t=Date.now();for(;Date.now()-t<s;);}}function P(s,t=[50,100,250,500,1e3,2e3,4e3]){let e;for(let n=0;n<=t.length;n++)try{return s()}catch(r){let o=r instanceof Error?r.message:String(r);if(!o.includes("SQLITE_BUSY")&&!o.includes("database is locked"))throw r;e=r instanceof Error?r:new Error(o),n<t.length&&at(t[n])}throw new Error(`SQLITE_BUSY: database is locked after ${t.length} retries. Original error: ${e?.message}`)}function M(s,t,e={}){return P(()=>{let n=new s(t,{timeout:e.busyTimeoutMs??3e4});try{return it(n),n}catch(r){throw b(n),r}},e.retryDelays)}function ct(s){return s.includes("SQLITE_CORRUPT")||s.includes("SQLITE_NOTADB")||s.includes("database disk image is malformed")||s.includes("file is not a database")}function ut(s){let t=Date.now();for(let e of["","-wal","-shm"])try{J(s+e,`${s}${e}.corrupt-${t}`)}catch{}}var _=Symbol.for("__context_mode_live_dbs_v3__"),O=(()=>{let s=globalThis;return s[_]||(s[_]=new Set,process.on("exit",()=>{for(let t of s[_])b(t);s[_].clear()})),s[_]})(),T=class{#t;#e;#n;constructor(t,e={}){let n=rt();this.#t=t,this.#n=e.retryDelays,U(t);let r;try{r=M(n,t,e)}catch(o){let a=o instanceof Error?o.message:String(o);if(ct(a)){ut(t),U(t);try{r=M(n,t,e)}catch(c){throw new Error(`Failed to create fresh DB after renaming corrupt file: ${c instanceof Error?c.message:String(c)}`)}}else throw o}this.#e=r,O.add(this.#e),this.withRetry(()=>this.initSchema()),this.prepareStatements()}get db(){return this.#e}get dbPath(){return this.#t}close(){O.delete(this.#e),b(this.#e)}withRetry(t){return P(t,this.#n)}cleanup(){O.delete(this.#e),b(this.#e),ot(this.#t)}};import{createHash as g}from"node:crypto";import{execFileSync as dt}from"node:child_process";import{existsSync as m,realpathSync as lt,renameSync as R}from"node:fs";import{join as L}from"node:path";function F(s){let t=s.replace(/([A-Z0-9_]*(?:TOKEN|SECRET|PASSWORD|PASSWD|PWD|API[_-]?KEY|AUTH|COOKIE|CREDENTIAL)[A-Z0-9_]*=)(?:"[^"]*"|'[^']*'|[^\s]+)/gi,"$1<redacted>");return t=t.replace(/(https?:\/\/)([^:\s/@]+):([^@\s]+)@/gi,"$1<user>:<redacted>@"),t=t.replace(/(--(?:token|password|secret|api-key|auth|cookie)(?:=|\s+))(?:"[^"]*"|'[^']*'|[^\s]+)/gi,"$1<redacted>"),t}var h;function y(s){let t=s.replace(/\\/g,"/");return/^\/+$/.test(t)?"/":/^[A-Za-z]:\/+$/.test(t)?`${t.slice(0,2)}/`:t.replace(/\/+$/,"")}function j(s){let t=s;try{t=lt.native(s)}catch{}let e=y(t);return process.platform==="win32"||process.platform==="darwin"?e.toLowerCase():e}function G(s,t){return dt("git",["-C",s,...t],{encoding:"utf-8",timeout:2e3,stdio:["ignore","pipe","ignore"]}).trim()}var Et=new Set(["rawcommand","raw_command","rawoutput","raw_output","rawstdout","raw_stdout","rawstderr","raw_stderr","rawstdin","raw_stdin"]);function A(s,t){let e=s.toLowerCase();if(Et.has(e))return"<redacted:trace-forbidden-field>";if(e==="command"&&typeof t=="string")return F(t);if(Array.isArray(t))return t.map(n=>A("",n));if(t&&typeof t=="object"){let n={};for(let[r,o]of Object.entries(t))n[r]=A(r,o);return n}return t}function W(s){try{let t=JSON.parse(s);return!t||typeof t!="object"?s:JSON.stringify(A("",t))}catch{return s}}function pt(s){let t=G(s,["rev-parse","--show-toplevel"]);return t.length>0?y(t):null}function ht(s){let t=G(s,["worktree","list","--porcelain"]).split(/\r?\n/).find(e=>e.startsWith("worktree "))?.replace("worktree ","")?.trim();return t?y(t):null}function mt(s=process.cwd()){let t=process.env.CONTEXT_MODE_SESSION_SUFFIX;if(h&&h.projectDir===s&&h.envSuffix===t)return h.suffix;let e="";if(t!==void 0)e=t?`__${t}`:"";else try{let n=pt(s),r=ht(s);if(n&&r){let o=j(n),a=j(r);o!==a&&(e=`__${g("sha256").update(o).digest("hex").slice(0,8)}`)}}catch{}return h={projectDir:s,envSuffix:t,suffix:e},e}function Ot(){h=void 0}function Y(s){return g("sha256").update(y(s)).digest("hex").slice(0,16)}function z(s){let t=y(s),e=process.platform==="darwin"||process.platform==="win32"?t.toLowerCase():t;return g("sha256").update(e).digest("hex").slice(0,16)}function Nt(s){let{projectDir:t,contentDir:e}=s,n=z(t),r=L(e,`${n}.db`);if(m(r))return r;let o=Y(t);if(o===n)return r;let a=L(e,`${o}.db`);if(m(a))try{R(a,r);for(let c of["-wal","-shm"])try{R(a+c,r+c)}catch{}}catch{}return r}function wt(s){return q({...s,ext:".db"})}function At(s){return q({...s,ext:".code-index.db"})}function q(s){let{projectDir:t,sessionsDir:e,ext:n}=s,r=s.suffix??mt(t),o=z(t),a=L(e,`${o}${r}${n}`);if(m(a))return a;let c=Y(t);if(c===o)return a;let d=L(e,`${c}${r}${n}`);if(m(d))try{R(d,a);for(let l of["-wal","-shm"]){let u=`${d}${l}`,E=`${a}${l}`;m(u)&&!m(E)&&R(u,E)}}catch{}return a}var H=1e3,X=5;function S(s){let t=Number(s);return!Number.isFinite(t)||t<=0?0:Math.floor(t)}var i={insertEvent:"insertEvent",getEvents:"getEvents",getEventsByType:"getEventsByType",getEventsByPriority:"getEventsByPriority",getEventsByTypeAndPriority:"getEventsByTypeAndPriority",getEventCount:"getEventCount",getLatestAttributedProject:"getLatestAttributedProject",checkDuplicate:"checkDuplicate",evictLowestPriority:"evictLowestPriority",updateMetaLastEvent:"updateMetaLastEvent",updateMetaLastEvents:"updateMetaLastEvents",ensureSession:"ensureSession",getSessionStats:"getSessionStats",incrementCompactCount:"incrementCompactCount",upsertResume:"upsertResume",getResume:"getResume",markResumeConsumed:"markResumeConsumed",claimLatestUnconsumedResume:"claimLatestUnconsumedResume",deleteEvents:"deleteEvents",deleteMeta:"deleteMeta",deleteResume:"deleteResume",getOldSessions:"getOldSessions",searchEvents:"searchEvents",incrementToolCall:"incrementToolCall",getToolCallTotals:"getToolCallTotals",getToolCallByTool:"getToolCallByTool",getEventBytesSummary:"getEventBytesSummary",listSessions:"listSessions",getEventsSince:"getEventsSince",getLatestEvents:"getLatestEvents"},$=class extends T{constructor(t){super(t?.dbPath??B("session"),t)}stmt(t){return this.stmts.get(t)}initSchema(){try{let e=this.db.pragma("table_xinfo(session_events)").find(n=>n.name==="data_hash");e&&e.hidden!==0&&this.db.exec("DROP TABLE session_events")}catch{}this.db.exec(`
